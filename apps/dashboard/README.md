...
- **Live observability:** the right panel's **Live** tab polls GitHub Actions lifecycle state and, when configured, structured Aeon run events. See [`docs/observability.md`](../../docs/observability.md).
